...
// //   }
// // export function SupplierProfile({ supplier, onUpdate }: SupplierProfileProps) {
...
// // //     if (onUpdate) onUpdate(updatedSupplier)
// // //   }
...
// //     try {
// //       const updatedSupplier = await updateSupplier(currentSupplier.id, { profile_pic_url: imageUrl })
  
// //       setCurrentSupplier((prev) => ({
// //         ...prev,
// //         profileImage: updatedSupplier.profile_pic_url, // Ensure consistency with API response
// //       }))
...
// //     try {
// //       const updatedSupplier = await updateSupplier(currentSupplier.id, { cover_pic_url: imageUrl })
  
// //       setCurrentSupplier((prev) => ({
// //         ...prev,
// //         coverImage: updatedSupplier.cover_pic_url, // Ensure consistency with API response
// //       }))
...
// //   const handleBusinessDetailsUpdate = async (details: Partial<Supplier>) => {
// //     try {
...
// //         location: {
// //           lat: Number(details.location.lat), // Ensure number type
...
// //         location: {
// //           lat: updatedSupplier.location.lat.toString(), // Convert back to string
// //           lng: updatedSupplier.location.lng.toString(),
// //         },
// //       }));
...
// //           address: updatedSupplier.address,
// //           location: {
// //             lat: updatedSupplier.location.lat.toString(),
// //             lng: updatedSupplier.location.lng.toString(),
// //           },
// //         });
// //       }
...
// // Define a type for the business details update payload
...
//   const handleProfileImageUpdate = async (imageUrl: string) => {
//     try {
//       const updatedSupplier: Supplier = await updateSupplier(currentSupplier.id, { profile_pic_url: imageUrl })
...
//   const handleCoverImageUpdate = async (imageUrl: string) => {
//     try {
//       const updatedSupplier: Supplier = await updateSupplier(currentSupplier.id, { cover_pic_url: imageUrl })
...
//         telephone: details.telephone,
//         address: details.address,
//         // Convert the strings to numbers for the API
//         location: {
...
//         telephone: updatedSupplier.telephone,
//         address: updatedSupplier.address,
//         // Convert the API's number values back to strings
//         location: {
